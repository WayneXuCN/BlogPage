...
export async function GET(context: APIContext) {
  ...
  const siteDescription =
    currentLang === 'zh' ? siteConfig.description.zh : siteConfig.description.en;
